(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["statistics"] = factory();
	else
		root["statistics"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var types = {
	  max: {
	    ...
	    reduce: Math.max,
	    percent: function percent(total, quota) {
	      return total / quota;
	    },
	    isComplete: function isComplete(total, quota) {
	      return this.percent(total, quota) >= 1;
	    }
	  },
	  min: {
	...
	var Threshold = function () {
	  function Threshold(stat, quota, promise, resolve) {
	    var _this = this;
	    ...
	    this.tryComplete = function () {
	      return _this.isComplete() && resolve(_this.stat.value());
	    };
	  }
	  ...
	  _createClass(Threshold, [{
	    ...
	    value: function isComplete() {
	      var value = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.stat.value();
	...
	var Statistic = exports.Statistic = function () {
	  ...
	  _createClass(Statistic, [{
	    key: 'threshold',
	    value: function threshold(quota) {
	      var resolve = void 0;
	      var promise = new Promise(function (_resolve, reject) {
	        resolve = _resolve;
	      });
	      var thresh = new Threshold(this, quota, promise, resolve);
	      var index = _lodash2.default.sortedIndexOf(this.thresholds, thresh, this.type.sortBy);
	    ...
	    value: function value() {
	      return _lodash2.default.get(this, '_value', this.type.init);
	    }
	  }, {
	    key: 'toJson',
...
;
//# sourceMappingURL=swarm-statistics.js.map